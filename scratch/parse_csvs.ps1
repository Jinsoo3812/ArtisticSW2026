$csvFiles = @(
    "c:\Unreal Projects\ArtisticSW2026\Saved\Profiling\CSV\Profile(20260818_182922).csv",
    "c:\Unreal Projects\ArtisticSW2026\Saved\Profiling\CSV\Profile(20260818_183011).csv",
    "c:\Unreal Projects\ArtisticSW2026\Saved\Profiling\CSV\Profile(20260818_183133).csv"
)
...
Write-Host "=== 3회 런타임 CSV 프로파일 평균 결과 ==="
