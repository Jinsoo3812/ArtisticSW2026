...
#include "BoxInteractableComponent.generated.h"

class UUserWidget;

UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class ARTISTICSWCORE_API UBoxInteractableComponent : public UBoxComponent, public IInteractable
{
	GENERATED_BODY()

public:
	UBoxInteractableComponent();
...
public:
	...
	/** Draw this component's scaled collision box while playing. Disabled by default. */
