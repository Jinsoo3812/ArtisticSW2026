...
// ItemSlot Tag
GASCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Slot_Item);
GASCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Slot_Item_1);
GASCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Slot_Item_2);
GASCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Slot_Item_3);

// Crafter Slot Tag
GASCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Slot_Crafter_R);
